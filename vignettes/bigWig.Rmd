...
bed6.region.bpQuery.bigWig(bwPlus, bwMinus, bed6,
                           bwMap=bwMap)
```
The `bwMap` arguments incorporates the `strand`, either from the _BED6_ data frame or the argument, with the `read.len` and `read.left.edge` attributes from the`bwMap` _R_ object. 
