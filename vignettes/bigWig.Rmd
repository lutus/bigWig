...
```{r bigWigPlusMinus, echo = FALSE, message=FALSE, fig.align='center', fig.pos = "H", fig.cap='Stranded bigWig files. Two bigWig files contain values that are strand-specific to highlight the _bed6_ functions.', out.width = "100%"}
...
site. THROW WARNINGS IF NOT FIXED WINDOW AS OPPOSED TO TRUNCATED MATRIX?
...
colnames(bed6)=c('chrom', 'start', 'end')
...
DOES bed.step.bpQuery.bigWig without a constant window just truncate?
